...
int main(int argc, char* argv[])
{
 ...
 if(com_mode == MIP_SDK_RQ1_IMU_DIRECT_MODE)
 {
  ...
  while(mip_3dm_cmd_hw_specific_imu_device_status(&device_interface, RQ1_IMU_MODEL_NUMBER, RQ1_IMU_BASIC_STATUS_SEL, (u8*)&imu_basic_field) != MIP_INTERFACE_OK){} 

  printf("Model Number: \t\t\t\t\t%04u\n", imu_basic_field.device_model);
  printf("Status Selector: \t\t\t\t%s\n", imu_basic_field.status_selector == RQ1_IMU_BASIC_STATUS_SEL ? "Basic Status Report" : "Diagnostic Status Report");
  ...
  while(mip_3dm_cmd_hw_specific_imu_device_status(&device_interface, RQ1_IMU_MODEL_NUMBER, RQ1_IMU_DIAGNOSTICS_STATUS_SEL, (u8*)&imu_diagnostic_field) != MIP_INTERFACE_OK){} 

  printf("Model Number: \t\t\t\t\t%04u\n", imu_diagnostic_field.device_model);
  printf("Status Selector: \t\t\t\t%s\n", imu_diagnostic_field.status_selector == RQ1_IMU_BASIC_STATUS_SEL ? "Basic Status Report" : "Diagnostic Status Report");
 ...
 ///
  ...
  //Request basic status report
  while(mip_3dm_cmd_hw_specific_device_status(&device_interface, RQ1_MODEL_NUMBER, RQ1_BASIC_STATUS_SEL, (u8*)&basic_field) != MIP_INTERFACE_OK){} 

  printf("Model Number: \t\t\t\t\t%04u\n", basic_field.device_model);
  printf("Status Selector: \t\t\t\t%s\n", basic_field.status_selector == RQ1_IMU_BASIC_STATUS_SEL ? "Basic Status Report" : "Diagnostic Status Report");
  ...
  //Request diagnostic status report
  while(mip_3dm_cmd_hw_specific_device_status(&device_interface, RQ1_MODEL_NUMBER, RQ1_DIAGNOSTICS_STATUS_SEL, (u8*)&diagnostic_field) != MIP_INTERFACE_OK){} 

  printf("Model Number: \t\t\t\t\t%04u\n", diagnostic_field.device_model);
  printf("Status Selector: \t\t\t\t%s\n", diagnostic_field.status_selector == RQ1_IMU_BASIC_STATUS_SEL ? "Basic Status Report" : "Diagnostic Status Report");
