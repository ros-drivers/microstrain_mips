...
int main(int argc, char **argv){
  ...
  ros::init(argc, argv, "set_gravity_adaptive_vals_client");

  ros::NodeHandle n;
  ros::ServiceClient client = n.serviceClient<ros_mscl::SetGravityAdaptiveVals>("SeGravityAdaptiveVals");
  ros_mscl::SetGravityAdaptiveVals srv;
