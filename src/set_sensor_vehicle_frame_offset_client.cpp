...
int main(int argc, char **argv){
  ...
  ros::NodeHandle n;
  ros::ServiceClient client = n.serviceClient<microstrain_3dm_gx5_45::SetSensorVehicleFrameOffset>("SetSensorVehicleFrameOffset");
  microstrain_3dm_gx5_45::SetSensorVehicleFrameOffset srv;
