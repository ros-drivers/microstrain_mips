...
int main(int argc, char **argv){
  ...
  ros::NodeHandle n;
  ros::ServiceClient client = n.serviceClient<microstrain_3dm::SetSensorVehicleFrameTrans>("SetSensorVehicleFrameTrans");
  microstrain_3dm::SetSensorVehicleFrameTrans srv;
