...
int main(int argc, char **argv){
  ...
  ros::NodeHandle n;
  ros::ServiceClient client = n.serviceClient<microstrain_3dm::SetZeroAngleUpdateThreshold>("SetZeroAngleUpdateThreshold");
  microstrain_3dm::SetZeroAngleUpdateThreshold srv;
